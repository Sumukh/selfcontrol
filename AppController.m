...
//            [statusItem setTitle:@" SelfControl"];

            [currentStatus setTitle:@"Active"];
            [currentStatus setEnabled:YES];
      ...
      [self closeDomainList];
        ...
        NSString *timeleft = [defaults_ stringForKey:@"timeleft"];
        [currentStatus setTitle:timeleft];
       // [statusItem setTitle:timeleft];
    ...
    if(blockWasOn) { // if we just switched states to off...
      [timerWindowController_ blockEnded];
        ...
        [currentStatus setTitle:@"Inactive"];
        [currentStatus setEnabled:NO];
...
- (void)applicationDidFinishLaunching:(NSNotification *)aNotification {
  ...
  [initialWindow_ center];
    ...
    [statusItem setMenu:statusMenu2];
    [statusItem setTarget:self];
   // [statusItem setAction:@selector(openWindow:)];

    [statusItem setHighlightMode:YES];
    [statusItem setTitle:@"Main SelfControl"];
    
    [statusItem setImage:[NSImage imageNamed:@"small_selfcontrol.png"]];
